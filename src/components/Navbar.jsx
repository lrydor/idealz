    ...
    <nav className="w-full bg-white border-b shadow-sm">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden md:flex items-center gap-5">
            <a href="/menu" className="text-black hover:underline font-medium">Menu</a>
            <a href="#about" className="text-black hover:underline font-medium">About</a>
            <a href="#contact" className="text-black hover:underline font-medium">Contact</a>

            {userName ? (
              <>
                <span className="text-black font-medium">Hello, {userName}!</span>
                <button
      ...
      {isOpen && (
        <div className="md:hidden px-4 pt-2 pb-4 space-y-2">
          <a href="/menu" onClick={() => setIsOpen(false)} className="block text-gray-700 hover:underline">Menu</a>
          <a href="#about" onClick={() => setIsOpen(false)} className="block text-gray-700 hover:underline">About</a>
          <a href="#contact" onClick={() => setIsOpen(false)} className="block text-gray-700 hover:underline">Contact</a>

          {userName ? (
            <>
              <span className="block text-black font-medium">Hello, {userName}!</span>
              <button
                onClick={() => {
                  setIsOpen(false);
                  handleLogout();
